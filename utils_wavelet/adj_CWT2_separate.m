% adj_CWT2.m
% Adjoint of CWT2_separate
%
% function u = adj_CWT2_separate([Whh, Wgg, Whg, Wgh], Faf, af, J, symF, symh, symg);
%
% Usage: u = adj_CWT2([Whh, Wgg, Whg, Wgh], Faf, af, J, symF, symh, symg);
% u - nxn image (n must be a power of 2)
% Fsep = [Whh Wgg Whg Wgh]/sqrt(4);
...
function u = adj_CWT2_separate(Fsep, Faf, af, J, symF, symh, symg);
